package com.senpiper.liv2train.trainingcenter.model;
...
public class TrainingCenter {
	...
	public AddressEmbedebble getAddress() {
		return address;
	}
	public void setAddress(AddressEmbedebble address) {
