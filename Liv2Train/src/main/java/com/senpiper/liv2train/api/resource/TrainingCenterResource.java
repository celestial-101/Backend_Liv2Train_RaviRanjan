package com.senpiper.liv2train.api.resource;
...
import com.senpiper.liv2train.trainingcenter.service.TrainingCenterService;

@RestController
public class TrainingCenterResource {
	
	@Autowired
	TrainingCenterService trainingService;
